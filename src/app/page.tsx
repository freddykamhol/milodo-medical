            ...
            <div className="md:col-span-5">
              <div className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] shadow-[var(--shadow)]">
                ...
                >
                  ...
                  <div className="pointer-events-none absolute inset-0 bg-white/95 [mask-image:radial-gradient(circle_at_center,transparent_54%,black_78%,black_100%)] [-webkit-mask-image:radial-gradient(circle_at_center,transparent_54%,black_78%,black_100%)]" />
