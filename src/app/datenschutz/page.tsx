    ...
    <main className="min-h-dvh bg-[var(--background)] text-[var(--foreground)]">
      <div className="mx-auto max-w-4xl px-6 py-14">
        ...
        <p className="mt-4 text-sm leading-relaxed text-[color:var(--muted)]">
          ...
          Bitte ergänze fehlende Angaben (mit „—“ gekennzeichnet) vor dem Launch.
        </p>
        ...
        <section className="mt-10 grid gap-3 text-sm leading-relaxed text-[color:var(--muted)]">
          ...
          <p>
            Die Speicherdauer der Logfiles richtet sich nach den Einstellungen des Hosting-Providers und wird nur so
            lange vorgehalten, wie es für Betrieb und Sicherheit erforderlich ist.
          </p>
        </section>
        ...
        <section className="mt-10 grid gap-3 text-sm leading-relaxed text-[color:var(--muted)]">
          ...
          <p>
            ...
            Server dieser Website übertragen, sondern in deinem E-Mail-Programm übernommen und über deinen
            E-Mail-Anbieter versendet.
          </p>
          <p>
        ...
        <section className="mt-10 grid gap-3 text-sm leading-relaxed text-[color:var(--muted)]">
          ...
          <p>
            Für Hosting und Betrieb der Website können Dienstleister als Auftragsverarbeiter eingesetzt werden. In
            diesen Fällen bestehen Verträge zur Auftragsverarbeitung (Art. 28 DSGVO).
          </p>
        </section>
